...
| 2 | `docs/需求文档-v2.md` | **唯一权威需求**（冻结版）。有冲突以本文档为准 |
| 3 | `docs/架构说明.md` | 目录结构、请求流程、模块职责 |
| 4 | `docs/工具开发规范.md` | 写工具前必读 |
| 5 | `docs/manifest规范.md` | manifest 字段与校验 |
| 6 | `docs/编码规范.md` | 命名、缩进、提交信息 |
| 7 | `docs/安全规范.md` | 敏感操作前必读 |
| 8 | `docs/图标与许可证.md` | 图标来源与合规要求 |
| 9 | `tasks/Px-*.md` | 当前阶段任务清单 |
...
- 列出**验证方式**（跑了什么命令、结果如何）
- 若引入新文件，说明它在架构中的位置
- 若与 `docs/需求文档-v2.md` 有冲突，**先指出冲突**，不要擅自决定
...
| 需要新建顶层目录 | 影响架构，必须先确认 |
| 需要改 `docs/需求文档-v2.md` 的冻结决策 | 属于契约变更，必须先确认 |
