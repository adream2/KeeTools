...
TOOL_MARKERS = {
    ...
    "derivative-graph": ['id="expr"', 'id="cv"'],
    "conic-sections": ['class="cs-tab', 'id="equation"'],
    "solid-rotation": ['class="sr-tab', 'id="angle"'],
    "magnetic-field": ['class="mf-tab', 'id="plot"'],
    "projectile-motion": ['class="pm-mode', 'id="v0"'],
    "newton-second-law": ['id="force"', 'id="aBadge"'],
    "binary-converter": ['id="inDec"', 'class="bc-lamp'],
    "sorting-visual": ['id="algo"', 'id="btnStep"'],
